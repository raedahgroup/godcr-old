...
var (
	DefaultTextColor              = color.RGBA{9, 20, 64, 255}
	DarkerBlueGrayTextColor       = color.RGBA{61, 88, 115, 255}
	...
	TransactionInfoColor          = color.RGBA{89, 109, 129, 255}
	SpendableLabelColor           = color.RGBA{89, 109, 129, 255}
	BlueGreen                     = color.RGBA{45, 216, 163, 255}
