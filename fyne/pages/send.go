...
func sendPageContent(multiWallet *dcrlibwallet.MultiWallet, window fyne.Window) (pageContent fyne.CanvasObject) {
	...
	totalCostLabel := widget.NewLabel(sendpagehandler.NilAmount)
	balanceAfterSendLabel := widget.NewLabel(sendpagehandler.NilAmount)
	transactionFeeLabel := widget.NewLabel(sendpagehandler.NilAmount)
	transactionSizeLabel := widget.NewLabel(sendpagehandler.ZeroByte)
