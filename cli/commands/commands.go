...
type Commands struct {
	...
	Balance         BalanceCommand         `command:"balance" description:"Show total balance for each account in wallet" long-description:"Shows total balance for each account in wallet. Also shows spendable balance if different from total balance. Use -d/--detailed to view a more detailed balance breakdown"`
	...
	Help            HelpCommand            `command:"help" description:"Show application help, run 'help' for general help 'help <command-name>' for command-specific help."`
}
