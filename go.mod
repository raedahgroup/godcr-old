...
require (
	...
	github.com/raedahgroup/godcr/cmd/godcr-nuklear v0.0.0-00010101000000-000000000000 // indirect
...
replace (
	...
	github.com/raedahgroup/godcr/cmd/godcr-nuklear => ./cmd/godcr-nuklear
