...
import (
	...
	"github.com/raedahgroup/godcr/gio"
...
func main() {
	...
	// check if user passed commands/options/args in non-cli (gio) mode
	if len(args) > 0 {
	...
	log.Info("Launching desktop app with gio")
	gio.LaunchApp(ctx, walletMiddleware, &appConfig.Settings)
