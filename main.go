...
func main() {
	...
	case "nuklear":
		enterNuklearMode(ctx, walletMiddleware, appConfig)
	case "fyne":
...
func enterNuklearMode(ctx context.Context, walletMiddleware app.WalletMiddleware, appConfig *config.Config) {
